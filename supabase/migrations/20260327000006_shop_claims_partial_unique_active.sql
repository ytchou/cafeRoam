...
-- Renamed from 20260327000002 (duplicate version). IF EXISTS guards for idempotency on local re-run.
ALTER TABLE public.shop_claims DROP CONSTRAINT IF EXISTS shop_claims_shop_id_key;

CREATE UNIQUE INDEX IF NOT EXISTS shop_claims_shop_id_active
