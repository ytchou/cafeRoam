                    ...
                    "content": [
                        ...
                        },
                        {
                            ...
                            "text": (
                                ...
                                f"\n\nReference — menu item names (prefer exact terms): {_MENU_VOCAB_REF}"
                                "\n\nFor item names, prefer the Traditional Chinese term from the list above where applicable (e.g. 手沖 not 'pour over', 可頌 not 'croissant')."
                            ),
                        },
                    ],
                }
