...
- [ ] Install SDK dependencies (@anthropic-ai/sdk, openai) and extend pipeline types
- [ ] Retry utility with exponential backoff (TDD)
- [ ] Cosine similarity utility (TDD)
...
- [ ] Search queries config (10 test queries)
