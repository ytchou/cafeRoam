...
- backend/scripts/seed*shops_csv.py:45-47 — `.in*()` batching; low-risk at current volumes
...
- [Minor] backend/scripts/seed*shops_csv.py:45-47 — `.in*()` query not batched for large CSVs (low risk at current usage volumes, deferred)
