...
- [Minor] `sentry.server.config.ts:5`, `sentry.edge.config.ts:5` — Added clarifying comments on NEXT_PUBLIC_ server availability
...
*Agents skipped (no code findings): Plan Alignment*
